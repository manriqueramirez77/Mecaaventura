...
MechaType es una aplicación basada en web basada en MT, creada para que los niños y jóvenes salvadoreños desarrollen y practiquen sus habilidades de mecanografía. Intentando emular una experiencia de scritura natural durante Tests proveyendo feedback instantanea en errores, velocidad y precisión al escribir.


# Features

- Diseño minimalista y simple de usar
- Errores en vivo, palabras por minuto y disposición de precisión
- Variedad de longitud de Tests y modos
- Punctuation and numbers modes
- Modo de puntuación y números
- Citas de autores
- Temas
- Cuentas
